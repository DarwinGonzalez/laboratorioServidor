...
class AppOpenCV{
   public static void main(String[] args){
      ...
      Mat img = OpenCVUtils.readFile("/home/twcam/opencv/images/descargadas/prueba.png");
      Mat blur = OpenCVUtils.blur(img);
      OpenCVUtils.writeImage(blur,"/home/twcam/opencv/images/procesadas/prueba.png");
   }
}
